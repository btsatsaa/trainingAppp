    ...
    >
      ...
      <div className="z-10 max-w-screen-lg xl:max-w-screen-xl sm:flex sm:justify-between sm:items-center py-6">
        ...
        <div className="hidden sm:flex justify-between items-center flex-col md:flex-row">
          {isLoggedIn ? (
            <>
              <div className="block text-left text-lg font-medium text-primary-dark dark:text-ternary-light hover:text-secondary-dark dark:hover:text-secondary-light sm:mx-4 mb-2 sm:py-2" aria-label="Profile">
                <ProfileDropdown />
              </div>
              <div className="block text-left text-lg font-medium text-primary-dark dark:text-ternary-light hover:text-secondary-dark dark:hover:text-secondary-light sm:mx-4 mb-2 sm:py-2" aria-label="Notifications">
                <NotificationCus />
              </div>
            </>
          ) : (
